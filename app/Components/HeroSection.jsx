      ...
      <div className="flex flex-wrap">
        <div className="w-full lg:w-1/2">
          <div className="flex flex-col items-center lg:items-start">
            <h1 className="pb-12 text-5xl font-thin tracking-tight lg:mt-16 lg:text-7xl bg-gradient-to-r from-white via-gray-400 select-none to-gray-700 text-transparent bg-clip-text ">
